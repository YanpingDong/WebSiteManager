...
INSERT INTO `sys_menu` (`id`, `parent_id`, `parent_ids`, `name`, `href`, `target`, `icon`, `sort`, `is_show`, `create_date`, `update_date`, `remarks`, `del_flag`) VALUES
	...
	('10', '3', '0,1,2,3,', '字典管理', '/sys/dict/', NULL, 'th-list', 60, '1', '2013-05-27 08:00:00', '2013-05-27 08:00:00', NULL, '0'),
	...
	('67', '2', '0,1,2,', '日志查询', NULL, NULL, NULL, 985, '1', '2013-06-03 08:00:00', '2013-06-03 08:00:00', NULL, '0'),
	('68', '67', '0,1,2,67,', '日志查询', '/sys/log', NULL, 'pencil', 30, '1', '2013-06-03 08:00:00', '2013-06-03 08:00:00', NULL, '0');
